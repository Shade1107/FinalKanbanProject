        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                    <div class="text">
                        <h1 class="loginFormText mt-5 "> Add Task</h1>
                    </div>
                    ...
                    <div class="Yinput-container text-center">
                        ...
                        <?php if(isset($error_messages['task_name'])) { ?>
                            <div style="color: red;"><?php echo $error_messages['task_name']; ?></div>
                        <?php } ?>
                    </div>
                    ...
                    <?php if(isset($error_messages['short_description'])) { ?>
                        <div style="color: red;"><?php echo $error_messages['short_description']; ?></div>
                    <?php } ?>
